...
export class DishController {
    ...
    @ApiQuery({ name: "filter", required: false, type: String, description: "Filter by name (contains) or price (equals, gt, gte, lt, lte). Operator should start and end with ':'. You can do many conditions by separating them with ';'.", example: "name:contains:maza;price:gte:10000" })
